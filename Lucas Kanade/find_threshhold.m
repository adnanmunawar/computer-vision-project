%   Not my function, work of "zephyr". Using to find the threshold in image
function level=find_threshhold(I)
%   find_threshhold Compute global image threshold using iterative isodata method.
